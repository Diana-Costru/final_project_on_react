      ...
      return(
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            ...
            <CardText style={{fontFamily:'Volkorn'}}>
    ...
    return(
      <div>
        <Tabs activeTab={this.state.activeTab} onChange={(tabId) => this.setState({ activeTab: tabId })} ripple>
          <Tab style={{fontFamily:'Abril Fatface'}}>Literature</Tab>
          <Tab style={{fontFamily:'Abril Fatface'}}>Math</Tab>
          <Tab style={{fontFamily:'Abril Fatface'}}>Biology</Tab>
          <Tab style={{fontFamily:'Abril Fatface'}}>Physics</Tab>
        </Tabs>
